...
class Info extends \Magento\Framework\View\Element\Template
{
    ...
    {
        $newsletterText = $this->scopeConfig->getValue('account_dashboard/newsletter/text', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
        if($this->scopeConfig->isSetFlag('account_dashboard/newsletter/text', \Magento\Store\Model\ScopeInterface::SCOPE_STORE))
            return $newsletterText;
        return 'You aren\'t subscribed to our newsletter.';
    }
}
